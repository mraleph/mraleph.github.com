...
hljs.registerLanguage('dart', function (_hljs)
{
  ...
  {
    cN: 'comment',
    b: OPENING_BLOCK_COMMENT, e: CLOSING_BLOCK_COMMENT,
    c: ['self']
  };
  var INTERPOLATION =
  {
  ...
  return {
    ...
    [
      {
        cN: 'javadoc', //  was dartdoc, but better use a relatively standard name
        b: '/\\*\\*', e: '\\*/',
        c:
        [{
          cN: 'javadoctag', // was dartdocref, see above...
          b: DART_DOC_REF
        }],
        r: 7
      },
