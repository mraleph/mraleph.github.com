...
Another issue that can negatively impact performance of closure based code is that V8 supports inlining across context boundaries only on ia32. On other architectures callee will never be inlined into caller [if they have different context objects](http://code.google.com/p/v8/source/browse/trunk/src/hydrogen.cc?r=12566#6952).
